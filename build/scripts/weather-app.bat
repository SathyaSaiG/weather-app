...
set CLASSPATH=%APP_HOME%\lib\weather-app-1.0.jar;%APP_HOME%\lib\json-20230227.jar;%APP_HOME%\lib\gson-2.13.1.jar;%APP_HOME%\lib\error_prone_annotations-2.38.0.jar


@rem Execute weather-app
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %WEATHER_APP_OPTS%  -classpath "%CLASSPATH%" com.sathyasaig.weatherapp.Main %*
